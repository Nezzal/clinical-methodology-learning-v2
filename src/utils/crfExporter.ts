...
export function parseMarkdownCrfToMethodoSchema(
  ...
  if (sections.length < 2) {
    return {
      ...
      code,
      version: '1.0',
      description: `Cahier d'observation clinique généré automatiquement par Methodo-Clinique pour l'étude ${code}.`,
      author: 'Methodo-Clinique',
  ...
  return {
    ...
    code,
    version: '1.0',
    description: `Cahier d'observation clinique généré par Methodo-Clinique pour ${code}.`,
    author: 'Methodo-Clinique',
    category: metadata.methodology || 'Recherche Clinique',
    dateCreated: new Date().toISOString(),
    rawMarkdown: markdownText,
