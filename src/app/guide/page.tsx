      ...
      <section className={styles.card}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem', marginBottom: '1rem' }}>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid var(--border-glass)', borderRadius: '12px', padding: '1.25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <a 
              href="https://github.com/Nezzal/clinical-methodology-learning-v2/releases/download/v2.0.2/RECIF-MethodoClinique.Setup.2.0.2.exe" 
              target="_blank" 
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid var(--border-glass)', borderRadius: '12px', padding: '1.25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <a 
              href="https://github.com/Nezzal/clinical-methodology-learning-v2/releases/download/v2.0.2/RECIF-MethodoClinique-2.0.2-arm64.dmg" 
              target="_blank" 
              rel="noopener noreferrer"
              className="btn btn-primary"
              style={{ textAlign: 'center', padding: '0.65rem 0.85rem', fontSize: '0.88rem', textDecoration: 'none', fontWeight: 600 }}
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid var(--border-glass)', borderRadius: '12px', padding: '1.25rem', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <a 
                href="https://github.com/Nezzal/clinical-methodology-learning-v2/releases/download/v2.0.2/RECIF-MethodoClinique-2.0.2-arm64.AppImage" 
                target="_blank" 
                rel="noopener noreferrer"
                className="btn btn-primary"
              ...
              <a 
                href="https://github.com/Nezzal/clinical-methodology-learning-v2/releases/download/v2.0.2/clinical-methodology-learning_2.0.2_arm64.deb" 
                target="_blank" 
                rel="noopener noreferrer"
